...
<div class="app">
	<main>
		<div class="explanation"> 
			<h1>How To Play?</h1>
			<h2>You will be presented with one pokemon and 18 different types</h2>
			<h2>Is up to you to determine wich of the types is the correct primary type of the given pokemon</h2>
		</div>

		<a href="/type"><button type='button'>Back</button></a>
	</main>
