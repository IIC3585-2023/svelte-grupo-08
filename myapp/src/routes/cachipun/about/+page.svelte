...
<div class="app">
	<main>
		<div class="explanation"> 
			<h1>How To Play?</h1>
            <h2>This is a variation of Rock Paper Scissors but with Pokemon types</h2>
            <h2>Grass beats Water</h2>
            <h2>Water beats Fire</h2>
            <h2>Fire beats Grass</h2>
            <h2>Pick your choice and see if you beat the computer</h2>


		</div>

		<a href="/cachipun"><button type='button'>Back</button></a>
	</main>
